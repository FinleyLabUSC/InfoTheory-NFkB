...
for idx=1:8
    ...
    mutinfo(idx,7) = mi_cont_cont(Ant_concs, makesUnique(NFkB_maxima_agg_extend'./NFkB_maxima_agg_baseline'), 5)/log(2);
    
end

figure(1)
b = bar(mutinfo(:,[4 5 6 7]), 'FaceColor','flat') % Divide by log(2) to convert MI to a base 2 estimate
