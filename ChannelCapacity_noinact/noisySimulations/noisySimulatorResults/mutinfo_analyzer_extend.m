...
filenames{1} = ["results_extend_20_025", "results_extend_20_05", "results_extend_20_075",...
                 "results_extend_20_1", "results_extend_20_125", "results_extend_20_15", ...
                 "results_extend_20_175", "results_extend_20_2", "results_extend_20_5",];

filenames{2} = ["results_extend_01_025", "results_extend_01_05", "results_extend_01_075",...
                 "results_extend_01_1", "results_extend_01_125", "results_extend_01_15", ...
                 "results_extend_01_175", "results_extend_01_2", "results_extend_01_5",];

filenames{3} = ["results_extend_1_025", "results_extend_1_05", "results_extend_1_075",...
                   "results_extend_1_1", "results_extend_1_125", "results_extend_1_15", ...
                   "results_extend_1_175", "results_extend_1_2", "results_extend_1_5",];

filenames{4} = ["results_extend_065_025", "results_extend_065_05", "results_extend_065_075",...
                   "results_extend_065_1", "results_extend_065_125", "results_extend_065_15", ...
                   "results_extend_065_175", "results_extend_065_2", "results_extend_065_5",];

filenames{5} = ["results_extend_146_025", "results_extend_146_05", "results_extend_146_075",...
                   "results_extend_146_1", "results_extend_146_125", "results_extend_146_15", ...
                   "results_extend_146_175", "results_extend_146_2", "results_extend_146_5",];

filenames{6} = ["results_extend_05_025", "results_extend_05_05", "results_extend_05_075",...
                   "results_extend_05_1", "results_extend_05_125", "results_extend_05_15", ...
                   "results_extend_05_175", "results_extend_05_2", "results_extend_05_5",];

filenames{7} = ["results_extend_18_025", "results_extend_18_05", "results_extend_18_075",...
...
filenames{8} = ["results_extend_042_025", "results_extend_042_05", "results_extend_042_075",...
                   "results_extend_042_1", "results_extend_042_125", "results_extend_042_15", ...
                   "results_extend_042_175", "results_extend_042_2", "results_extend_042_5"];

filenames{9} = ["results_extend_078_025", "results_extend_078_05", "results_extend_078_075",...
                   "results_extend_078_1", "results_extend_078_125", "results_extend_078_15", ...
                   "results_extend_078_175", "results_extend_078_2", "results_extend_078_5"];

filenames{10} = ["results_extend_127_025", "results_extend_127_05", "results_extend_127_075",...
                   "results_extend_127_1", "results_extend_127_125", "results_extend_127_15", ...
                   "results_extend_127_175", "results_extend_127_2", "results_extend_127_5"];

filenames{11} = ["results_extend_208_025", "results_extend_208_05", "results_extend_208_075",...
                   "results_extend_208_1", "results_extend_208_125", "results_extend_208_15", ...
                   "results_extend_208_175", "results_extend_208_2", "results_extend_208_5"];

filenames{12} = ["results_extend_036_025", "results_extend_036_05", "results_extend_036_075",...
                   "results_extend_036_1", "results_extend_036_125", "results_extend_036_15", ...
                   "results_extend_036_175", "results_extend_036_2", "results_extend_036_5"];

filenames{13} = ["results_extend_239_025", "results_extend_239_05", "results_extend_239_075",...
                   "results_extend_239_1", "results_extend_239_125", "results_extend_239_15", ...
                   "results_extend_239_175", "results_extend_239_2", "results_extend_239_5"];

filenames{14} = ["results_extend_023_025", "results_extend_023_05", "results_extend_023_075",...
                   "results_extend_023_1", "results_extend_023_125", "results_extend_023_15", ...
                   "results_extend_023_175", "results_extend_023_2", "results_extend_023_5"];

filenames{15} = ["results_extend_059_025", "results_extend_059_05", "results_extend_059_075",...
                   "results_extend_059_1", "results_extend_059_125", "results_extend_059_15", ...
                   "results_extend_059_175", "results_extend_059_2", "results_extend_059_5"];

filenames{16} = ["results_extend_157_025", "results_extend_157_05", "results_extend_157_075",...
                   "results_extend_157_1", "results_extend_157_125", "results_extend_157_15", ...
                   "results_extend_157_175", "results_extend_157_2", "results_extend_157_5"];

filenames{17} = ["results_extend_339_025", "results_extend_339_05", "results_extend_339_075",...
                   "results_extend_339_1", "results_extend_339_125", "results_extend_339_15", ...
                   "results_extend_339_175", "results_extend_339_2", "results_extend_339_5"];

filenames{18} = ["results_extend_088_025", "results_extend_088_05", "results_extend_088_075",...
                   "results_extend_088_1", "results_extend_088_125", "results_extend_088_15", ...
                   "results_extend_088_175", "results_extend_088_2", "results_extend_088_5"];

filenames{19} = ["results_extend_111_025", "results_extend_111_05", "results_extend_111_075",...
                   "results_extend_111_1", "results_extend_111_125", "results_extend_111_15", ...
                   "results_extend_111_175", "results_extend_111_2", "results_extend_111_5"];

filenames{20} = ["results_extend_789_025", "results_extend_789_05", "results_extend_789_075",...
                   "results_extend_789_1", "results_extend_789_125", "results_extend_789_15", ...
                   "results_extend_789_175", "results_extend_789_2", "results_extend_789_5"];

filenames{21} = ["results_extend_0_025", "results_extend_0_05", "results_extend_0_075",...
...
for jdx=1:8
    ...
    correl(1,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(2,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(3,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(4,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(5,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(6,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(7,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
for jdx=1:8
    ...
    correl(8,jdx) = corr(NFkB_dump, Ant_concs,'type','spearman');
...
legend(["2 inputs", "3 inputs", "4 inputs", "5 inputs", "6 inputs", "7 inputs", "11 inputs", "20 inputs"])
